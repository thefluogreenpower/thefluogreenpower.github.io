...
$(window).load(function () {
  setTimeout(function () {
    $(".overlay").vegas({
      slides: [
        { src: "img/testimonials/slideshow/covid_domiciliare.jpeg" },
        {
          src: "img/testimonials/slideshow/mensa_suore_bernardino_varese.jpeg",
        },
        {
          src:
            "img/testimonials/slideshow/ospedale_angera_infermiera_tamponi_covid.jpeg",
        },
        {
          src: "img/testimonials/slideshow/ospedale_busto_chirurgia_1.jpeg",
        },
        {
